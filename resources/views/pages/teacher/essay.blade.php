...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Essay</li>
  </ol>
  <h6 class="font-weight-bolder mb-0">Essay</h6>
</nav>
@endsection
...
<ul class="navbar-nav">
  <li class="nav-item">
    <a class="nav-link" href="/tambahSoal">
...
<li class="nav-item">
    <a class="nav-link active" href="/essay">
      <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
{{-- @section('konten')
<form method="POST" action="" class="row g-3 px-3">
    @csrf
    <div class="col-12">
    ...
    <div class="col-12">
      ...
      <a href="/materi"><button class="btn btn-primary float-end" type="submit">Kembali</button></a>
    </div>
</form>
<script>
