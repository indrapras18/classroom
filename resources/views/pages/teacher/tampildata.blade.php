...
@section('konten')
<form action="/updateKelas/{{ $data->id }}" method="POST" style="margin-left: 20px; margin-right: 20px;">
  @csrf
  <div class="col-12">
      <label class="form-label" for="inputAddress2">Nama Kelas</label>
      <input class="form-control" name="nama_kelas" value="{{ $data->nama_kelas }}" id="inputAddress2" type="text" placeholder="Judul Materi">
  </div>
  <div class="col-12">
      <label class="form-label" for="inputAddress2">Dibuat</label>
      <input class="form-control" name="created_at" value="{{ $data->created_at }}" id="inputAddress2" type="text" placeholder="Refrensi">
  </div>
  <div class="col-12 mt-5 d-flex justify-content-between">
    <button class="btn btn-primary w-50 me-2" type="submit">Simpan</button>
    <a href="/kelas" class="w-50"><button class="btn btn-danger w-100" type="button">Kembali</button></a>
  </div>
</form>
