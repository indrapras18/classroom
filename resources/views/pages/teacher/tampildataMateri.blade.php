...
<form method="POST" action="/updateMateri/{{ $data->id }}" class="row g-3 px-3">
    ...
    <div class="col-12">
      ...
      <input class="form-control" name="nama_materi" value="{{ $data->nama_materi }}" id="inputAddress2" type="text" placeholder="Judul Materi">
    </div>
    <div class="col-12">
      <label class="form-label" for="inputAddress2">Refrensi</label>
      <input class="form-control" name="link" value="{{ $data->link }}" id="inputAddress2" type="text" placeholder="Judul Materi">
    </div>
