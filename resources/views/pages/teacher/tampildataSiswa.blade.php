...
@section('konten')
<form action="/updateSiswa/{{ $data->id }}" method="POST" style="margin-left: 20px; margin-right: 20px;">
  @csrf
  <div class="col-12">
      <label class="form-label" for="inputAddress2">Nama Siswa</label>
      <input class="form-control" name="name" value="{{ $data->name }}" id="inputAddress2" type="text" placeholder="Nama Siswa">
  </div>
  <div class="col-12">
    <label class="form-label" for="inputAddress2">Email Siswa</label>
    <input class="form-control" name="email" value="{{ $data->email }}" id="inputAddress2" type="email" placeholder="Email Siswa">
  </div>
  <div class="col-12">
    <label class="form-label" for="inputAddress2">Status</label>
    <input class="form-control" name="role" value="{{ $data->role }}" id="inputAddress2" type="role" placeholder="Status" disabled>
  </div>
  <div class="col-12">
