...
@section('modal')
<a href="{{ route('essay', ['id' => $tugasEssay->id]) }}"><button type="button" class="btn btn-primary float-end">Tambah Soal</button></a>
    </button>
    ...
    @foreach ($soal as $item)
      <tr>
          ...
          <td class="align-middle text-center">
            ...
            <a href="/deleteSoalEssay/{{ $item->id }}"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a>
          </td>
      </tr>
    @endforeach
  </tbody>
