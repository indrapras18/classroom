...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
    ...
    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pilihan Ganda </li>
  </ol>
...
<ul class="navbar-nav">
  <li class="nav-item">
    <a class="nav-link active" href="/tambahSoal">
...
<li class="nav-item">
    <a class="nav-link" href="/essay">
      ...
      <span class="nav-link-text ms-1">Essay</span>
    </a>
  </li>
</ul>
@endsection
...
<form method="POST" action="/uploadSoal" class="row g-3 px-3">
  ...
  <div class="col-12">
    ...
    <select class="form-select" name="id_materi" aria-label="Default select example">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <label for="inputEmail4" class="form-label">Kunci Jawaban</label>
      <input type="text" name="answer_key" class="form-control" id="inputEmail4">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-12">
      <label for="inputAddress" class="form-label">Opsi Jawaban</label>
    </div>
    <div class="container">
      <div class="row mb-3 align-items-center">
          <div class="col-md-2">
              <label for="inputAddress" class="form-label">Jawaban A</label>
          </div>
          <div class="col-md-10">
      ...
      <div class="row mb-3 align-items-center">
          <div class="col-md-2">
              <label for="inputAddress2" class="form-label">Jawaban B</label>
          </div>
          <div class="col-md-10">
              <input type="text" class="form-control"  placeholder="Jawaban">
          </div>
      ...
      <div class="row mb-3 align-items-center">
        <div class="col-md-2">
            <label for="inputAddress" class="form-label">Jawaban C</label>
        </div>
        <div class="col-md-10">
            <input type="text" class="form-control"  placeholder="Jawaban">
        </div>
    ...
    <div class="row mb-3 align-items-center">
      <div class="col-md-2">
          <label for="inputAddress" class="form-label">Jawaban D</label>
      </div>
      <div class="col-md-10">
          <input type="text" class="form-control"  placeholder="Jawaban">
      </div>
