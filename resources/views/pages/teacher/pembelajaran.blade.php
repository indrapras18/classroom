                ...
                @foreach($scores->unique('id_user') as $score)
                    <tr>
                        ...
                        <td class="align-middle text-center">
                          ...
                          {{-- <a href="/tampildataSiswa/{{ $score->id }}"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen-to-square "></i></button></a> --}}
                          {{-- <a href="/deleteSiswa/{{ $score->id }}"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a> --}}
                        </td>
                    </tr>
                @endforeach
            </tbody>
