...
@section('modal')
     <a href="/uploadMateri"><button type="button" class="btn btn-primary float-end">Tambah Materi</button></a>
    </button>
    ...
    @foreach ($materi as $item)
      <tr>
          ...
          <td class="align-middle text-center">
            <a href="/detailMateri/{{ $item->id }}"><button type="button" class="btn btn-info"><i class="fa-solid fa-eye"></i></button></a>
