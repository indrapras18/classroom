...
<body>
    <section class="vh-100" style="background-color: #43b5d8;">
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form method="POST" action="{{ route('login') }}" class="register-form" id="register-form">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="email" id="form2Example17" class="form-control form-control-lg" name="email" placeholder="Your Email"/>
                                        </div>
